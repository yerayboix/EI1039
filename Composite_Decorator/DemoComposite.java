...
public class DemoComposite {
    public static void main(String[] args) {
        ...
        sabinaPlaylist.add(new SongDecorator(new Song("Princesa", "Joaquín Sabina"), "vinyl"));
        sabinaPlaylist.add(new SongDecorator(new Song("Calle melancolía", "Joaquín Sabina"), "MP4"));
