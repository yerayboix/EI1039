...
public class DemoComposite {
    public static void main(String[] args) {
        ...
        sabinaPlaylist.add(new SongConcreteDecoratorVinyl(new Song("Princesa", "Joaquín Sabina")));
        sabinaPlaylist.add(new SongConcreteDecoratorMP4(new Song("Calle melancolía", "Joaquín Sabina")));
